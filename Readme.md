...
* **IEEE 754 Floats:** This method constructs floating-point numbers between $0.0$ and $1.0$ according to the [IEEE 754 standard](https://en.wikipedia.org/wiki/IEEE_754), focusing on generating the mantissa randomly while keeping the exponent and sign fixed.
...
* **Hash-Function:** Utilize hash function, seeded with rng block and rehashed again and again using a counter xored to the output of the last output. avalanche should do the trick.
