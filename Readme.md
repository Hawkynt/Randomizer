...
### Feedback with Carry Shift Register (FCSR) [^24]

[^24]:[FCSR](https://www.researchgate.net/publication/220738954_A_Survey_of_Feedback_with_Carry_Shift_Registers)
...
### Additive Congruential Random Number Generator (ACORN) [^25]

[^25]: [ACORN](https://acorn.wikramaratna.org/concept.html)
...
[^26]: [PCG](https://www.pcg-random.org/pdf/hmc-cs-2014-0905.pdf)
...
[^27]: [MIXMAX](https://arxiv.org/pdf/1403.5355)
...
### Mersenne Twister (MT) [^28]

[^28]: [MT](https://www.sciencedirect.com/topics/computer-science/mersenne-twister)
...
### Well Equidistributed Long-Period Linear (WELL) [^29]

[^29]: [WELL](https://www.iro.umontreal.ca/~lecuyer/myftp/papers/lfsr04.pdf)
...
[^30]: [BM](https://pages.cs.wisc.edu/~cs812-1/blum.micali82.pdf)
...
### Self-shrinking Generator (SSG) [^31]

[^31]: [SSG](https://link.springer.com/book/10.1007/BFb0053418)
...
### Blum Blum Shub (BBS) [^32] [^33]

[^32]: [BBS](https://www.cs.miami.edu/home/burt/learning/Csc609.062/docs/bbs.pdf)
[^33]: [BBS-Paper](https://people.tamu.edu/~rojas/bbs.pdf)
...
[^34]: [CC20](https://www.chronox.de/chacha20_drng/)
...
[^35]: [YAR](https://www.schneier.com/wp-content/uploads/2016/02/paper-yarrow.pdf)
...
[^36]: [FORT](https://www.codeproject.com/Articles/6321/Fortuna-A-Cryptographically-Secure-Pseudo-Random-N)

[^37]: [FORT-Paper](https://www.schneier.com/wp-content/uploads/2015/12/fortuna.pdf)
...
[^38]: [ANSI](https://www.researchgate.net/publication/267297736_EFFICIENT_COMBINATION_OF_SEVERAL_TECHNIQUES_IN_THE_DESIGN_AND_IMPLEMENTATION_OF_A_NETWORKS_SECURITY_SYSTEM)
...
### Inverse Transform Sampling (ITS) [^39]

[^39]: [ITS](https://brilliant.org/wiki/inverse-transform-sampling/)
...
### Box-Muller Method (BM) [^40]

[^40]: [BM](https://www.researchgate.net/publication/264324131_Box-Muller_transformation)
...
### Marsaglia Polar Method (MP) [^41]

[^41]: [MP](https://www.jstor.org/stable/2027592)
...
[^42]: [ZIG](https://www.jstatsoft.org/article/view/v005i08)
